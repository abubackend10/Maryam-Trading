# Generated by Django 5.1.15 on 2026-06-13 09:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(upload_to="about/", verbose_name="Изображение"),
                ),
            ],
            options={
                "verbose_name": "О нас",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icon",
                    models.CharField(max_length=100, verbose_name="Иконка FontAwesome"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="Название марки"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icon",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Иконка FontAwesome"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        max_length=255, verbose_name="Название (Марка и модель)"
                    ),
                ),
                ("description", models.TextField(verbose_name="Описание")),
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("new", "Новый"), ("used", "С пробегом")],
                        default="used",
                        max_length=10,
                        verbose_name="Статус",
                    ),
                ...
                (
                    "image",
                    models.ImageField(
                        upload_to="cars/", verbose_name="Главное изображение"
                    ),
                ),
                (
                    "video_url",
                ...
                (
                    "wheel",
                    models.CharField(
                        choices=[("Левый", "Левый"), ("Правый", "Правый")],
                        default="Левый",
                        max_length=100,
                        verbose_name="Руль",
                    ),
